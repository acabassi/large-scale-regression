...
def main(_):
    ...
    if FLAGS.job_name == "ps":
        ...
        with tf.device(tf.train.replica_device_setter(
            ...
            ### Add new function to calculate area under the curve to the regressor
            regressor = tf.contrib.estimator.add_metrics(regressor, metric_auc)
            ...
            regressor.train(train_inpf)

            ### Evaluate linear regressor
            result = regressor.evaluate(test_inpf)
            ...
            if FLAGS.task_index==0:
                ...
                weight_names, weight_est = get_flat_weights(regressor)
            ...
            pred_results = regressor.predict(input_fn=predict_inpf)
